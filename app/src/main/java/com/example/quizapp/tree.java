...
public class tree extends MenuPage{
    TextView qstn;
    ModelClass mc ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new ModelClass("Which of the following properties are obeyed by all three tree – traversals?" , "Left subtrees are visited before right subtrees", "Right subtrees are visited before left subtrees"  , "Root node is visited before left subtree" , "Root node is visited before right subtree" , "Left subtrees are visited before right subtrees"));
        list.add(new ModelClass("If binary trees are represented in arrays, what formula can be used to locate a left child, if the node has an index i?" , "2i+1", "2i+2" , "2i" , "4i" , "2i+1"));
    ...
    private void GameOver() {
        Intent i = new Intent(tree.this , gameover.class);
