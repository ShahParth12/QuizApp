...
public class queue extends MenuPage{
    TextView qstn;
    ModelClass mc ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new ModelClass("Queues serve major role in" , "Simulation of recursion", "Simulation of arbitrary linked list"  , "Simulation of limited resource allocation" , "All of the mentioned" , "Simulation of limited resource allocation"));
        list.add(new ModelClass("Which one of the following is an application of Queue Data Structure?" , "When a resource is shared among multiple consumers", "When data is transferred asynchronously (data not necessarily received at same rate as sent) between two processes" , "Load Balancing" , "All of the above" , "All of the above"));
    ...
    private void GameOver() {
        Intent i = new Intent(queue.this , gameover.class);
